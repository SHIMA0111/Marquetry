...
def multi_precision(y, t, target_class=1, dtype="float64"):
    """Calculate precision for a specific target class based on true labels and predicted values.
        ...
        Args:
            ...
            t (:class:`marquetry.Variable` or :class:`numpy.ndarray` or :class:`cupy.ndarray`):
                The true labels.
            target_class (int, optional): The class index to calculate precision for.
                Defaults to 1.
            dtype (str or numpy.dtype):
                The return value's dtype, Default is "float64" that means 64-bit float value.

        Returns:
        :class:`marquetry.Variable`, :class:`numpy.ndarray`, or :class:`cupy.ndarray`: The precision for the specified target class
