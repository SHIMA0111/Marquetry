...
import matrixml.core
from matrixml import Variable
from matrixml.utils import gradient_check, array_equal
...
class TestAdd(unittest.TestCase):
    ...
    def test_backward3(self):
        ...
        self.assertTrue(gradient_check(matrixml.core.add, x, y))
...
class TestSub(unittest.TestCase):
    ...
    def test_backward3(self):
        ...
        self.assertTrue(gradient_check(matrixml.core.sub, x, y))
